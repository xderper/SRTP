              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <ul className="space-y-2 text-gray-300">
                    <li><strong>Полное наименование:</strong><br />Индивидуальный предприниматель Иванов Иван Иванович</li>
                    <li><strong>Сокращенное наименование:</strong><br />ИП Иванов И.И.</li>
            ...
            <section className="bg-gray-800 rounded-lg p-6">
              ...
              <div className="space-y-4 text-gray-300">
                <div>
                  ...
                  <p>
                    ИП Иванов И.И. осуществляет деятельность по продаже садовых инструментов и оборудования 
